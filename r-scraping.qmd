...
Two questions that we could ask using the ACS data are:

1. What percentages of different genders voted for each candidate in each county?

2. What percentages of different races voted for each candidate in each county?
