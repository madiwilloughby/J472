...
```
    #A senior reporter at ProPublica is making $230,504.
...
```
    ...
    #The median salary for editors is 60,240.0.
...
```
    ...
    #The highest paid editor is a senior photo editor at Tribune Publishing. 
...
#The median salary for New York Times employees is 52,000.
...
#The highest paid person at the New York Times is an executive news editor who is Black and wrote no answer for gender.
```
...
#The median salary at Bloomberg is 50,000, s its a little lower than the New York Times but very similar.
