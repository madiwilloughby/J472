...
Something you could answer using a spatial buffer could be where different levels of affordable housing are located within a city. Also, you could use a spatial buffer to compare the locations of voting locations to data about the demographics of the areas most of them are located in.
