...
In order to clean the data, you would use the mutate and then case when function to either change all of the times it is written as "Maryland" to "MD" or to change all the times it is written as "MD" to "Maryland".
