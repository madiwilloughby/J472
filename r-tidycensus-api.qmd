...
male_population_2020 <- get_acs(geography = "state", 
      variables = c("B01001_001" , "B01001_02"), 
      year = 2020 ,output = "wide")
```

```{r}
male_population_2020 %>% 
  select(NAME, B01001_001E, B01001_002E) %>% 
  mutate(male_pop_pct = B01001_002E/B01001_001E*100) %>% 
  arrange(desc(male_pop_pct))
